...
'cookie_pre' => 'gIYlp_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
//附件相关配置
'upload_path' => JAE_PATH.'uploadfile/',
'upload_url' =>  JAE_PATH.'/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' =>  JAE_PATH.'/statics/js/', //CDN JS
'css_path' =>  JAE_PATH.'/statics/css/', //CDN CSS
'img_path' =>  JAE_PATH.'/statics/images/', //CDN img
'app_path' => '/',//动态域名配置地址

'charset' => 'gbk', //网站字符集
'timezone' => 'Asia/Hong_Kong', //网站时区（只对php 5.1以上版本有效），Etc/GMT-8 实际表示的是 GMT+8
'debug' => 0, //是否显示调试信息
'admin_log' => 1, //是否记录后台操作日志
'errorlog' => 1, //1、保存错误日志到 cache/error_log.php | 0、在页面直接显示
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'x76XKAOlCZwGPxhrGZSZ', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso_auth_key' => 'dor0apcWpzmiseggglwrsUvGOliMYHPt', //加密密钥
