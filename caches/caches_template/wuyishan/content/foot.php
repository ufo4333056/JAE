<?php defined('IN_JAE') or exit('No permission resources.'); ?><!-- 底部 -->
	...
	<div class="bder">
		<div class="wrap">
		<div class="dilo">
				<?php $result=query('SELECT * FROM jae_weblink WHERE typeid=23 ORDER BY listorder,id ASC   LIMIT 17,1 '); 
					foreach ($result as $v) {
					?><a href="<?php echo $v['link'];?>"><img height="70" src="<?php  echo $v['picture'];?>" /></a>
					<?php }
					?>	
			</div>
			<div class="tle">
