...
'easing': 'easeIn','triggerType':'mouse', 'steps':1, 'viewSize': [290], 'circular': true, 'activeTriggerCls':'curr','prevBtnCls': 'mall-prev', 'nextBtnCls': 'mall-next', 'disableBtnCls': 'disable','autoplay':'true','duration':'1'}">
                    <div class="sk-time" style="z-index:10">
                        <!-- <div class="sk-t-text">ÃëÉ±µ¹¼ÆÊ±</div> -->
                    ...
                    <div class="sk-con switchable-content" >
                        ...
                        <div class="sk-item ui-switchable-panel morning selected" style="z-index: 1; opacity: 1; ">
                            ...
                            <li><div class="p-img"><a href="<?php echo $r['detail_url'];?>" target="_blank"><img width="180" height="180" src="<?php echo $r['pic_url'];?>" ></a></div><div class="p-name"><a href="<?php echo $r['detail_url'];?>"  target="_blank"><?php echo $r['title'];?></a></div><div class="p-price"><strong>£¤<?php echo $r['coupon_price'];?></strong><del><?php echo $r['price'];?></del></div><div class="p-btn"><a class="btn-m seckilling" href="<?php echo $r['detail_url'];?>" target="_blank">Á¢¼´ÃëÉ±</a></div></li>
                            <?php } ?>
...
<?php $result=get_goods(18,10);foreach( $result as $r){ ?>
                                    ...
                                    <div class="p-ext">
										...
										<div class="p-btn"><a class="btn-s addCart" href="<?php echo $r['detail_url'];?>" title="<?php echo $r['title'];?>" target="_blank">Á¢¼´¹ºÂò</a></div>
                                    </div>
                                </li>
								  <?php }?>    
															                        </ul>
                            ...
                            <ul class="clearfix sub-item" >
                           	...
                           	<?php $result=get_goods(22,15);foreach( $result as $r){ ?>
                                    ...
                                    <div class="p-ext">
                                        <div class="p-name"><a href="<?php echo $r['detail_url'];?>" title="<?php echo $r['title'];?>" target="_blank"><?php echo $r['title'];?></a></div>
                                        <div class="p-btn">
										<a class="btn-s addCart" href="<?php echo $r['detail_url'];?>" title="<?php echo $r['title'];?>" target="_blank">Á¢¼´¹ºÂò</a>
										</div>
                                    </div>
									</li>
					<?php }?>
