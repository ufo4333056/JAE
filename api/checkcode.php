...
$session_storage = 'session_'.jae_base::load_config('system','session_storage');
jae_base::load_sys_class($session_storage);
$checkcode = jae_base::load_sys_class('checkcode');
