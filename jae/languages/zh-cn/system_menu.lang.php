...
$LANG['goods'] = '商品管理';
$LANG['goods_add'] = '添加商品';
$LANG['goods_edit'] = '编辑商品';
$LANG['goods_delete'] = '删除商品';
$LANG['goods_data'] = '商品数据管理';
$LANG['gd_id'] = 'ID';
$LANG['gd_level'] = '商品等级';
$LANG['gd_cat'] = '商品所属类目';
$LANG['gd_name'] = '商品名称';
...
$LANG['gd_area'] = '商品产地';
$LANG['gd_key'] = '品类特色词';
$LANG['gd_cycle'] = '产品供货周期';
$LANG['gd_storage'] = '建议仓储地点';
$LANG['gd_method'] = '最佳仓储方式';
$LANG['gd_delivery'] = '最佳发货时间';
$LANG['gd_certify_geog'] = '地理标志产品认证';
$LANG['gd_certify_organic'] = '有机食品认证';
$LANG['gd_certify_innocuity'] = '无公害产品认证';
$LANG['gd_certify_green'] = '绿色食品认证';
$LANG['supply'] = '供应商管理';
$LANG['supply_add'] = '添加供应商';
$LANG['supply_edit'] = '编辑供应商';
$LANG['supply_delete'] = '删除供应商';
$LANG['sup_id'] = 'ID';
$LANG['gds_id'] = 'ID';
$LANG['sup_name'] = '供应商名称';
$LANG['sup_level'] = '供应商等级';
$LANG['sup_contacts'] = '供应商联系人';
$LANG['sup_addres'] = '供应商地址';
$LANG['sup_tel'] = '供应商电话';
$LANG['sup_email'] = '供应商EMAIL';
$LANG['sup_ww'] = '供应商旺旺或QQ';
$LANG['sup_source'] = '供应商性质';
$LANG['sup_ability'] = '供货能力';
$LANG['goods_data_add'] = '添加商品数据';
$LANG['goods_data_edit'] = '编辑商品数据';
$LANG['goods_data_delete'] = '删除商品数据';
$LANG['param'] = '商品规格';
$LANG['pub_price'] = '当地市场售价';
$LANG['first_price'] = '一手采购价';
$LANG['online_price'] = '线上挂牌价';
$LANG['dis_price'] = '线上活动价';
$LANG['diliver'] = '是否包邮';
$LANG['pack'] = '包装方式';
$LANG['pack_cost'] = '包装成本';
$LANG['warn'] = '注意事项';
$LANG['express'] = '快递公司';
$LANG['delivery_cost'] = '单品快递费用';
