...
<form name="myform" id="myform" action="/admin.php?m=position&c=position&a=edit" method="post">
...
<!--table_form_off-->
<div class="btns"><input name="posid" type="hidden" value="<?php echo $posid?>"><input type="submit" id="dosubmit" class="button" name="dosubmit" value="提交"></div>
