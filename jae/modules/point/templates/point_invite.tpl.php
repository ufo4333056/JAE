...
<form name="myform" id="myform" action="/admin.php?m=point&c=point_set&a=point_invite" method="post">
<table width="100%" class="table_form contentWrap">
      ...
      <tr>
       ...
       <tr>
        <th>生成邀请链接的描述：</th>
        <td>
          <textarea style="width:350px;height:100px;" name="setting[content_url]"><?php echo $content_url?></textarea>
