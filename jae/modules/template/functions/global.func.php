...
function creat_template_bak($filepath, $style, $dir) {
	...
	$template_bak_db = jae_base::load_model('template_bak_model');
	$template_bak_db->insert(array('creat_at'=>SYS_TIME,'fileid'=>$style."_".$dir."_".$filename, 'userid'=>'1', 'username'=>'admin_username', 'template'=>new_addslashes(htmlspecialchars(file_get_contents($filepath))))); 
}
