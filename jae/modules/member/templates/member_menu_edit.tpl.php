...
<form name="myform" id="myform" action="/admin.php?m=member&c=member_menu&a=edit" method="post">
<table width="100%" class="table_form contentWrap">
	...
	<tr>
       ...
       <tr>
        <th>显示位置：</th>
        <td><input type="radio" name="info[project1]" value="1" <?php if($project1==1) echo "checked";?>> 左<input type="radio" name="info[project1]" value="0" <?php if($project1==0) echo "checked";?>> 右</td>
      </tr>
