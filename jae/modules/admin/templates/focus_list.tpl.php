...
<div class="table-list">
    <table width="100%" cellspacing="0" class="table_form">
       <tbody>
            ...
            <td align="center"><?php echo '<a href="/admin.php?m=admin&c=focus&a=edit&id='.$r['id'].'&menuid='.$menuid.'">'.L('modify').'</a> | <a href="/admin.php?m=admin&c=focus&a=delete&id='.$r['id'].'&menuid='.$menuid.'">'.L('delete').'</a> ';?></td>
