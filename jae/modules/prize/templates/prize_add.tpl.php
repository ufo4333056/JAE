...
<form name="myform" id="myform" action="/admin.php?m=prize&c=prize_set&a=add" method="post">
<table width="100%" class="table_form contentWrap">
      ...
      <tr>
       ...
       <tr>
        ...
        <tr>
        <th>中奖机率：</th>
        <td><input size="6" type="text" name="info[odds]"  value="<?php echo $odds?>" id="language" class="input-text"><div id="nameTip" class="onShow">/百万分之 （数字整数）</div></td>
      </tr>
      <tr>
        <th>奖品数量：</th>
