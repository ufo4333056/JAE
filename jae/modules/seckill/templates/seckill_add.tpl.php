...
<font color="red"><?php echo $message;?></font>
  <form name="form1" method="post" action="/admin.php?m=seckill&c=seckill&a=add&menuid=<?php echo  $this->menuid?>" >
            ...
            <form name="form2"  method="post"   action="/admin.php?m=seckill&c=seckill&a=add&menuid=<?php echo  $this->menuid?>">
                <table class="table_form" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <td>
                            <ul>
                                ...
                                <li>
                                    ...
                                    <input name="info[end_time]" class="kg_datePicker  input-text" type="text"  value="<?php echo date('Y-m-d H:i:s', time()+3600); ?>"/>
                                </li>
                            </ul>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><label> 是 <input class="input-text" type="radio" name="info[iskill]" size="50" value="1" check="checked"  ></label><label> 否<input class="input-text" type="radio" name="info[iskill]" checked="checked" size="50" value="0"> </label></td>
                    </tr>
                     <tr>
